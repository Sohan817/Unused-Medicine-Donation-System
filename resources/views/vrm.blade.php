...
tr:nth-child(even) {
  background-color: #dddddd;
    ...
    <style>
        ...
        <h1 style=color:black><b>REQUEST LIST</b></h1>
        <table border="2">
          <tr>
          ...
          <td style=color:black><b>Donate</b></td>
          </tr>
           @foreach($Requs as $Requs)
           <tr>
           <td style=color:black>{{$Requs['id']}}</td>
           <td style=color:black>{{$Requs['fullname']}}</td>
           <td style=color:black>{{$Requs['address']}}</td>
           <td style=color:black>{{$Requs['brandname']}}</td>
           <td style=color:black>{{$Requs['genericname']}}</td>
           <td style=color:black>{{$Requs['quantity']}}</td>
           <td style=color:black>{{$Requs['medicinetype']}}</td>
           <td style=color:black>{{$Requs['email']}}</td>
           <td style=color:black>{{$Requs['phone']}}</td>
