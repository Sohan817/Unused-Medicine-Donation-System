...
tr:nth-child(even) {
  background-color: #dddddd;
    ...
    <style>
                body{
                    background-image:url(images/mnp.jpg);
                    background-attachment: fixed;
                    background-size: 100% 100%;
                }
            </style>
        <h1 style=color:black><b>NGO/NPO LISTS</b></h1>
        <table border="2">
          <tr>
          ...
          <td style=color:black><b>Established</b></td>
          <td style=color:black><b>Name Of The Members</b></td>
          <td style=color:black><b>Email</b></td>
          <td style=color:black><b>Remove Users</b></td>
          </tr>
           @foreach($ngors as $data)
           <tr>
          ...
          <input type="hidden"name="id"value="{{$data->id}}">
           ...
           <td style=color:black>{{$data->establish}}</td>     
           <td style=color:black>{{$data->ntam}}</td>
