...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    style="color:white"><b>Back</b></a> </button> 
        <div class="flex-center position-ref full-height">
            ...
            @if (Session::get('user'))
            <div  class="container">
             <form class=" " action="{{URL::to('/req')}}" method="post">
              <label style="color:black"for="fullname"><strong>Full Name:</strong> </label> <br>
               <input type="text" name="fullname" value="">
               <br><br>
               <label style="color:black" for="email"><strong>Email ID:</strong></label> <br>
               <input type="text" name="email" value="">
               <br> <br>
               <label style="color:black" for="address"><strong>Address:</strong></label><br> 
               <input type="text" name="address" value=""> <br><br>
               <label style="color:black" for="brandname"><strong>Brand Name:</strong></label><br> 
               <input type="text" name="brandname" value="">
               <br><br>
               <label style="color:black" for="genericname"><strong>Generic Name:</strong></label> <br>
               <input type="text" name="genericname" value="">
               <br><br>
               <label style="color:black" for="quantity"><strong>Quantity:</strong></label> <br>
               <input type="integer" name="quantity" value="">
               <br><br>
               <label style="color:black" for="phone"><strong>Mobile Number:</strong></label> <br>
               <input type="integer" name="phone" value=""placeholder="+880">
               <br><br>
               <label style="color:black" for="medicinetype"><strong>Medicine Type:</strong></label> <br>
              ...
              @endif
                ...
                @else
                <div class="" style="margin: auto; background-color:#FFA07A; margin-top: 40vh;
                 width: 50%; border: 3px solid green; padding: 10px; color: black; text-align:center">
